...
async function main() {
  ...
  // ─── Seed Users Only ─────────────────────────────
  const users = [
    { name: 'System Admin', email: 'admin@example.com', password: 'Admin@123', role: 'ADMIN' as const },
    { name: 'Rahul Singh', email: 'sales@example.com', password: 'Sales@123', role: 'SALES' as const },
    { name: 'Suresh Kumar', email: 'warehouse@example.com', password: 'Warehouse@123', role: 'WAREHOUSE' as const },
